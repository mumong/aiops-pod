...
| pending-missing-pvc | 10 | L0 ❌ | ❌ | not found, persistentvolumeclaim, pvc, rc-pending-definitely-missing-pvc | - | nodeSelector, configmap | 50% | ✅ | 65s |
| pending-missing-pvc | 11 | L0 ❌ | ✅ | not found, persistentvolumeclaim, pvc, rc-pending-definitely-missing-pvc | - | - | 75% | ✅ | 81s |
| pending-missing-pvc | 12 | L1 ✅ | ❌ | not found, persistentvolumeclaim, pvc, rc-pending-definitely-missing-pvc | - | nodeSelector | 80% | ✅ | 83s |
...
| pending-missing-pvc | 23 | L0 ❌ | ❌ | not found, persistentvolumeclaim, pvc, rc-pending-definitely-missing-pvc | - | nodeSelector | 75% | ✅ | 82s |
...
| pending-missing-pvc | 40 | L0 ❌ | ❌ | not found, persistentvolumeclaim, pvc, rc-pending-definitely-missing-pvc | - | nodeSelector, configmap, secret | 67% | ✅ | 87s |
...
| pending-missing-pvc | 43 | L0 ❌ | ❌ | not found, persistentvolumeclaim, pvc, rc-pending-definitely-missing-pvc | - | nodeSelector | 67% | ✅ | 95s |
| pending-missing-pvc | 44 | L0 ❌ | ❌ | not found, persistentvolumeclaim, pvc, rc-pending-definitely-missing-pvc | - | nodeSelector | 75% | ✅ | 89s |
| pending-missing-pvc | 45 | L0 ❌ | ✅ | not found, persistentvolumeclaim, pvc, rc-pending-definitely-missing-pvc | - | - | 60% | ✅ | 92s |
| pending-missing-pvc | 46 | L0 ❌ | ❌ | not found, persistentvolumeclaim, pvc, rc-pending-definitely-missing-pvc | - | nodeSelector, configmap, secret | 67% | ✅ | 88s |
...
| pending-missing-pvc | 49 | L0 ❌ | ❌ | not found, persistentvolumeclaim, pvc, rc-pending-definitely-missing-pvc | - | nodeSelector | 60% | ✅ | 98s |
...
|------|-------|------------|----------------|------------|-----------|----------|
| pending-missing-pvc | pending | 84.0% | 100.0% | 68.2% | 1.1m | 50/50 |
