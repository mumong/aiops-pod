...
|------|---|------|------|------------|------------|------------|------|---------|------|
| pending-insufficient-cpu | 1 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 67% | ✅ | 135s |
...
| pending-insufficient-cpu | 4 | L1 ✅ | ✅ | Insufficient, cpu, 100000, 0/, nodes are available | - | - | 100% | ✅ | 124s |
...
| pending-insufficient-cpu | 10 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 113s |
| pending-insufficient-cpu | 11 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 75% | ✅ | 121s |
...
| pending-insufficient-cpu | 16 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 136s |
| pending-insufficient-cpu | 17 | L1 ✅ | ✅ | Insufficient, cpu, 100000, 0/, nodes are available | - | - | 100% | ✅ | 114s |
| pending-insufficient-cpu | 18 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 109s |
| pending-insufficient-cpu | 19 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 126s |
| pending-insufficient-cpu | 20 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 122s |
| pending-insufficient-cpu | 21 | L1 ✅ | ✅ | Insufficient, cpu, 100000, 0/, nodes are available | - | - | 100% | ✅ | 190s |
| pending-insufficient-cpu | 22 | L1 ✅ | ❌ | Insufficient, cpu | 100000, 0/, nodes are available | - | 100% | ✅ | 204s |
| pending-insufficient-cpu | 23 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 80% | ✅ | 126s |
| pending-insufficient-cpu | 24 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 101s |
| pending-insufficient-cpu | 25 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 124s |
| pending-insufficient-cpu | 26 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 117s |
| pending-insufficient-cpu | 27 | L1 ✅ | ✅ | Insufficient, cpu, 100000, 0/, nodes are available | - | - | 100% | ✅ | 145s |
| pending-insufficient-cpu | 28 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 80% | ✅ | 119s |
| pending-insufficient-cpu | 29 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 75% | ✅ | 117s |
| pending-insufficient-cpu | 30 | L1 ✅ | ✅ | Insufficient, cpu, 0/, nodes are available | - | - | 100% | ✅ | 122s |
| pending-insufficient-cpu | 31 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 75% | ✅ | 93s |
| pending-insufficient-cpu | 32 | L1 ✅ | ✅ | Insufficient, cpu, 0/, nodes are available | - | - | 83% | ✅ | 145s |
| pending-insufficient-cpu | 33 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 80% | ✅ | 118s |
...
| pending-insufficient-cpu | 39 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 80% | ✅ | 112s |
...
| pending-insufficient-cpu | 42 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 125s |
...
| pending-insufficient-cpu | 46 | L1 ✅ | ✅ | Insufficient, cpu, 100000, 0/, nodes are available | - | - | 80% | ✅ | 107s |
| pending-insufficient-cpu | 47 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 106s |
| pending-insufficient-cpu | 48 | L1 ✅ | ✅ | Insufficient, cpu | - | - | 100% | ✅ | 108s |
...
- 校正时间: 2026-05-26
- 校正标准: 最终报告明确指出 `rc-pending-insufficient-cpu` 的 `resources.requests.cpu=100000/100k` 远超任一节点 CPU 容量，并导致 `0/3 nodes are available: 3 Insufficient cpu`，判为根因正确。
- 误伤类型: `nodeSelector`/`PVC` 出现在“已排除/无此约束”的上下文中，不应计为冲突；`100k`、`100,000 millicores`、`100 核/100 vCPU` 等表达按语义命中 CPU request 异常处理。
- 保留失败: #3、#8、#15、#22、#34、#35、#36、#37、#40、#43、#45。主要原因是误判为镜像问题、模拟场景、真实集群资源耗尽、Webhook/调度器注入或 LLM 连接失败。
- 人工校正后: 39/50 正确，根因准确率 78.0%。

## 场景汇总

| Case | Group | 根因准确率 | Runbook 覆盖率 | 平均证据率 | 平均 MTTR | 成功运行 |
|------|-------|------------|----------------|------------|-----------|----------|
| pending-insufficient-cpu | pending | 78.0% | 98.0% | 87.1% | 2.0m | 50/50 |
